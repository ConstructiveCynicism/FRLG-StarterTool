...
The released exe includes FFmpeg (ffmpeg.org) in a GPL-3.0 build, used to read OBS recordings, and
is therefore distributed under the GNU General Public License v3 - see `LICENSE.md` and
